      ...
      <div className="footer__container container"><a className="footer__logo logo" href='/'><img className="logo__img" width="70" height="70" src="../img/svg/logo.svg" alt="Логотип"/></a>
        ...
        <section className="footer__nav-section footer__nav-section--links">
          ...
          <ul className="footer__nav-list">
            <li className="footer__nav-list-item"><a className="link" href="/">Где купить?</a>
            </li>
            <li className="footer__nav-list-item"><a className="link" href="/">Блог</a>
            </li>
            <li className="footer__nav-list-item"><a className="link" href="/">Вопрос - ответ</a>
            </li>
            <li className="footer__nav-list-item"><a className="link" href="/">Возврат</a>
            </li>
            <li className="footer__nav-list-item"><a className="link" href="/">Сервис-центры</a>
            </li>
          </ul>
        </section>
