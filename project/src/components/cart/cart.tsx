          ...
          <div className="cart">
            ...
            <div className="cart__footer">
              ...
              <div className="cart__total-info">
                <p className="cart__total-item"><span className="cart__total-value-name">Всего:</span><span className="cart__total-value">{formatPrice(totalQuantity)}</span></p>
                <p className="cart__total-item"><span className="cart__total-value-name">Скидка:</span><span className={`cart__total-value ${totalDiscount ? 'cart__total-value--bonus' : ''}`}>{totalDiscount ? `- ${formatPrice(totalDiscount)}` : '0 ₽'}</span></p>
                <p className="cart__total-item"><span className="cart__total-value-name">К оплате:</span><span className="cart__total-value cart__total-value--payment">{formatPrice(totalQuantity - totalDiscount)}</span></p>
