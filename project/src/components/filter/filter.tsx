...
function Filter () :JSX.Element {
  ...
  const resetPriceRangeFields = () => {
    if(minPriceField.current && maxPriceField.current){
      minPriceField.current.value = '';
      maxPriceField.current.value = '';
      dispatch(setPriceRangeFilter([0,0]));
    }
  };
  ...
  return (
    <form className="catalog-filter">
      ...
      <fieldset className="catalog-filter__block">
        ...
        <div className="catalog-filter__price-range">
          <div className="form-input">
            ...
            <input ref={minPriceField} type="number" placeholder={`${minPrice}`} id="priceMin" name="min" onBlur={handlePriceRangeChange}/>
          </div>
          <div className="form-input">
            <label className="visually-hidden">Максимальная цена</label>
            <input ref={maxPriceField} type="number" placeholder={`${maxPrice}`} id="priceMax" name="max" onBlur={handlePriceRangeChange}/>
          </div>
        </div>
      </fieldset>
      <fieldset className="catalog-filter__block">
        ...
        <div className="form-checkbox catalog-filter__block-item">
          <input className="visually-hidden" type="checkbox" id="acoustic" name={GuitarType.Acoustic} onChange={handleGuitarTypeChange}/>
          <label htmlFor={GuitarType.Acoustic}>Акустические гитары</label>
        </div>
        <div className="form-checkbox catalog-filter__block-item">
          <input className="visually-hidden" type="checkbox" id="electric" name={GuitarType.Electric} onChange={handleGuitarTypeChange}/>
          <label htmlFor={GuitarType.Electric}>Электрогитары</label>
        </div>
        <div className="form-checkbox catalog-filter__block-item">
          <input className="visually-hidden" type="checkbox" id="ukulele" name={GuitarType.Ukulele} onChange={handleGuitarTypeChange}/>
      ...
      <fieldset className="catalog-filter__block">
        ...
        <div className="form-checkbox catalog-filter__block-item">
          <input className="visually-hidden" type="checkbox" id="4-strings" name="4-strings" onChange={handleStringsCountChange} disabled={isActive(4)}/>
          <label htmlFor="4-strings">4</label>
        </div>
        <div className="form-checkbox catalog-filter__block-item">
          <input className="visually-hidden" type="checkbox" id="6-strings" name="6-strings" onChange={handleStringsCountChange} disabled={isActive(6)}/>
          <label htmlFor="6-strings">6</label>
        </div>
        <div className="form-checkbox catalog-filter__block-item">
          <input className="visually-hidden" type="checkbox" id="7-strings" name="7-strings" onChange={handleStringsCountChange} disabled={isActive(7)}/>
          <label htmlFor="7-strings">7</label>
        </div>
        <div className="form-checkbox catalog-filter__block-item">
          <input className="visually-hidden" type="checkbox" id="12-strings" name="12-strings" onChange={handleStringsCountChange} disabled={isActive(12)}/>
